    ...
    <v-container>
        ...
        <v-row v-else-if="props.question.questionType === 'FREE_TEXT'">
            ...
            <v-col cols="12" md="6">
                ...
                <v-alert v-if="props.answers !== undefined" border color="warning">Aufgrund technischer Limitierungen
                    kann nur die richtige Antwort angezeigt werden, welche nicht zwingend mit der eingegebenen Lösung
                    übereinstimmt.
                </v-alert>
